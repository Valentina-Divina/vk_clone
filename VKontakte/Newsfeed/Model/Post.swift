...
struct Post {
    ...
    static func fetchPosts() -> [Post] {
        ...
        let post2 = Post(createdBy: guts, timeAgo: "5 дней назад", caption: "Не могу понять, что мне нравиться больше. Самурай Джек или Аватар \u{1F914}", image: [UIImage(named: "jack"), UIImage(named: "avatar")], numberOfViews: 78)
        ...
        let post4 = Post(createdBy: shumerlya, timeAgo: "15 секунд назад", caption: "Жители залинейной части города Шумерля выражают руководству города и республики слова огромной благодарности за выделение средств на ремонт центральной в том микрорайоне дороги по улице Радищева. Еще в 2021 году здесь было уложено 600 метров асфальтового полотна с обустройством разворотной площадки у ДОСААФ. Также отремонтирован участок дороги по улице Котовского (от улицы Тургенева до улицы Радищева) протяженностью 200 метров. В том числе был покрыт асфальтом участок дороги по улице Интернациональной, с 2001 года его не ремонтировали.", image: [UIImage(named: "dorogiShumerli1"), UIImage(named: "dorogiShumerli2"), UIImage(named: "dorogiShumerli3")], numberOfViews: 1002)
