...
struct Post {
    ...
    static func fetchPosts() -> [Post] {
        ...
        let post2 = Post(views: [
            Header(timeAgo: "5 дней назад", createdBy: guts),
            Caption(caption: "Что вам нравиться больше: Самурай Джек или Аватар \u{1F914}"),
            Images(image: [UIImage(named: "jack"), UIImage(named: "avatar")]),
            Footer(numberOfViews: "78")
            ])
        ...
        let post3 = Post(views: [
            ...
            Caption(caption: "Монна Ванна» — картина английского художника-прерафаэлита Данте Габриэля Россетти, созданная в 1866 году. На данный момент картина находится в собрании галереи Тейт. текст"),
            Images(image: [UIImage(named: "dante" )]),
